...
setInterval(() => {
  http.get(`http://meaw2344.glitch.me/`); ///تعديل مهم حط بدل 333م البروجكت
}, 280000);
...
const dev = ["692735916862603366"]; ///تعديل مهم حط ايدي حسابك
const admin = "=";
var owner = "692735916862603366"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(
    `ON ${client.guilds.size} Servers '     Script By : Osama Khalid  `
  );
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("TEO "); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
...
let room = "750966253396688907"; //تعديل مهم ايدي روم عد الاعضاء والترحيب ، روم صوتي
